      ...
      <div className="about-me__article-box">
        <article className="about-me__article">
          ...
          <p className="about__article-text">
            ...
            У меня есть жена и сын. Я люблю слушать музыку (преимущественно -
            блэк метал), а ещё коллекционирую аудио-кассеты. С 2016 года работал
            в образовании. После того, как прошёл курс по веб-разработке, начал
            заниматься фриланс-заказами, ушёл с постоянной работы и поставил
            себе цель стать востребованным frontend-разработчиком.
          </p>
          <Link
